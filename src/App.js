...
import Fabrique_app from './components/Fabrique_app';
...
class App extends Component {
  ...
  getDoms () {
    ...
    // console.log('app.offsetHeight', app.offsetHeight)
    ...
    list.map(item => {
      ...
      console.log('dom', dom)
      console.log(item, dom.offsetHeight)
  ...
  componentDidMount() {
    ...
    // this.getDoms()
    // const list = ['aboutus', 'business', 'medium', 'glamor', 'contact'];
    // const list = ['aboutus', 'business', 'brand', 'fabrique_app', 'contact'];
    ...
    window.onscroll = e => {
      ...
      if (document.documentElement.scrollTop - temp1 > 0) {
        // result.filter(item => item.top > -50 && item.top < 50);
